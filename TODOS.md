...
- **Priority:** P1 — Add useMemo for derived state (selectedCard, filter categories) to reduce re-renders
...
- **Priority:** P1 — Extract `validate_path` into shared utility (currently duplicated in 3 files)
...
- **Priority:** P1 — Harden SSRF validation: block 127.0.0.0/8, 0.0.0.0, and DNS rebinding
...
- **Priority:** P1 — Add negative-path tests for `validate_ai_url`
- **Priority:** P1 — Add tests for `extract_param_placeholders` and `extract_risk_flags`
